...
static PyObject *py_mem_player_put_frame(PyObject *pSelf, PyObject *pArgs)
{
    ...
    pj_str_t frame = PyString_ToPJ(pFrame);
...
static PyObject *py_pjsua_init(PyObject *pSelf, PyObject *pArgs)
{
  ...
  p_cfg_media = &cfg_media;
    ...
    printf("sample_per_frame: %d, channel: %d, bits_per_sample: %d\n",pjsua_var.mconf_cfg.samples_per_frame, pjsua_var.mconf_cfg.channel_count, pjsua_var.mconf_cfg.bits_per_sample);
...
//        cfg.contact_rewrite_method = 0; // legacy behaviour
        //printf("X\n");
...
#define ADD_CONSTANT(mod,name)  PyModule_AddIntConstant(mod,#name,name)
    ...
    m = Py_InitModule3(
        "_pjsuaxt", py_pjsua_methods, "Extended PJSUA-lib module for python"
    );
